...
class SrgbTest {
    ...
    @Test
    void values() {
        Assertions.assertThat(new Srgb(1, 2, 3).coordinates()).contains(1.0, 2.0, 3.0);
    }
    ...
    void toXyzMatrix() {
        ...
        assertThat(sRgbToXyz[0]).isCloseTo(new double[]{0.4124564, 0.3575761, 0.1804375}, PRECISE);
        assertThat(sRgbToXyz[1]).isCloseTo(new double[]{0.2126729, 0.7151522, 0.0721750}, PRECISE);
        assertThat(sRgbToXyz[2]).isCloseTo(new double[]{0.0193339, 0.1191920, 0.9503041}, PRECISE);
    }
    ...
    void fromXyzMatrix() {
        ...
        assertThat(sRgbFromXyz[0]).isCloseTo(new double[]{3.2404542, -1.5371385, -0.4985314}, PRECISE);
        assertThat(sRgbFromXyz[1]).isCloseTo(new double[]{-0.9692660, 1.8760108, 0.0415560}, PRECISE);
        assertThat(sRgbFromXyz[2]).isCloseTo(new double[]{0.0556434, -0.2040259, 1.0572252}, PRECISE);
    }
