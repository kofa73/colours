...
public class LoadAndSaveSrgb {
    public static void main(String[] args) {
        if (args.length <= 3) {
            ...
            System.out.println("Transformer 3: Desaturate by scaling C of LCh_ab");
            System.out.println("Transformer 4: Desaturate by scaling C of LCh_uv");
            System.out.println("Transformer 5: Clip C of LCh_ab");
            System.out.println("Transformer 6: Clip C of LCh_uv");
            System.exit(1);
        }
